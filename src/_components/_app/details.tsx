    ...
    return (
        <>
            <article className={`${bricolage.className} w-full relative px-6 pb-3 pt-20`}>
                <h1>{parentTitle}</h1>
                <h2 className='mt-6' ref={infoRef}>{childTitle}</h2>
                {featuresList && <>
                ...
                <div className='mt-12' ref={previewRef}>
                    <h3>Preview</h3>
                    <div className='bg-gray-400/5 rounded-md p-6 border border-algae mt-2 w-full max-w-full'>
                        <PillsList data={data} />
                    </div>
                </div>
                <div className='mt-12' ref={componentCodeRef}>
                    <h3>Code</h3>
                    <DisplayCode code={code} />
                </div>
                <div className='mt-12' ref={usageCodeRef}>
                    <h3>Usage Code</h3>
                    <DisplayCode code={code} />
                </div>
                <div className='flex items-center justify-between mt-14 pt-10 pb-8 border-t border-algae'>
